...
// Single source of truth for FAQ — used by both JSON-LD schema and rendered HTML.
const FAQ_ITEMS: { q: string; a: string }[] = [
  { q: "מהו שיקום צנרת ללא הרס?", a: "שיקום צנרת ללא הרס הוא פתרון הנדסי מתקדם המאפשר להחזיר צנרת ישנה או פגומה לתפקוד מלא — מבלי לשבור קירות, רצפות או ריצוף וללא חפירות בחצר. השיקום מתבצע מתוך הצנרת עצמה בשיטות פאץ׳ או שרוול (CIPP), תוך שמירה מלאה על הבית." },
  { q: "מהו תיקון פאץ׳ בצנרת?", a: "תיקון פאץ׳ הוא טיפול נקודתי בקטע פגום — סדק, חור או חיבור דולף. מותקנת ׳טבעת׳ אפוקסי פנימית באורך של עד מטר, אשר אוטמת לחלוטין את הקטע הפגום ומחזירה את הצנרת לשימוש מלא ומידי." },
  { q: "מהו שיקום צנרת בשיטת שרוול (CIPP)?", a: "שיטת השרוול (Cured In Place Pipe) יוצרת ׳צינור בתוך צינור׳: שרוול רך ספוג ברזין אפוקסי מוחדר לתוך הקו הקיים ומתקשה למצב מוצק. התוצאה — קו חדש לחלוטין, חלק, עמיד וללא תפרים, לעשרות שנים." },
  { q: "האם חייבים לחפור או לשבור קירות?", a: "לא. זהו היתרון המרכזי של הטכנולוגיה. כל העבודה מתבצעת דרך פתחי גישה קיימים — ללא חפירות, ללא שבירת קירות ורצפות וללא צורך בעבודות שיקום להחזרת המצב לקדמותו." },
  { q: "כמה זמן נמשך התהליך?", a: "רוב תיקוני הפאץ׳ מתבצעים תוך מספר שעות באותו יום עבודה. שיקום מלא בשיטת שרוול לבניין אורך בדרך כלל בין יום אחד למספר ימי עבודה — בהתאם לאורך הקו, קוטרו ומורכבותו." },
  { q: "מתי מומלץ לבצע צילום קווי ביוב?", a: "מומלץ לבצע צילום קווי ביוב לפני רכישת נכס, לאחר סתימות חוזרות, כשמופיעות נזילות לא מוסברות, או כתחזוקה תקופתית למבני מגורים, ועדי בתים, מוסדות ועסקים — לאיתור מוקדם של שברים, שורשים וסתימות." },
  { q: "האם אתם עובדים עם ועדי בתים וחברות ניהול?", a: "בהחלט. אנו מבצעים שיקום צנרת וקווי ביוב לבניינים משותפים ולחברות ניהול נכסים — כולל תיאום מסודר, הצעת מחיר מפורטת לאסיפת דיירים וביצוע עם מינימום הפרעה לשוטף." },
  { q: "האם אתם עובדים עם עיריות ורשויות מקומיות?", a: "כן. TAYAR TECH מבצעת פרויקטים תשתיתיים עבור עיריות ורשויות מקומיות, בסטנדרט הנדסי גבוה, עמידה במפרטים ובלוחות זמנים והצגת תיעוד מלא של העבודה (צילום לפני/אחרי)." },
  { q: "מה תוחלת החיים של שיקום בשיטת שרוול?", a: "שרוול CIPP איכותי מתוכנן לתוחלת חיים של 50 שנה ומעלה — עמיד לשחיקה, לחומרים כימיים, לשורשים ולסתימות, ומחזיר את הקו לתפקוד מלא כמו קו חדש לחלוטין." },
  { q: "האם הטכנולוגיה מתאימה לכל סוגי הצנרת?", a: "כן. שיטות הפאץ׳ והשרוול מתאימות לצנרת ברזל, חרסינה, PVC, בטון ופלדה — בקטרים ואורכים שונים. אבחון מוקדם באמצעות מצלמת 360° קובע את הפתרון האופטימלי לכל מקרה." },
  { q: "מה כוללת הצעת המחיר ואיזו אחריות אתם נותנים?", a: "הצעת מחיר שקופה וסופית הכוללת אבחון וצילום ראשוני, ביצוע, חומרים, ציוד ואחריות מלאה בכתב — ללא תוספות סמויות. משך האחריות משתנה לפי סוג העבודה, ומגיע לעשרות שנים בשיטת שרוול CIPP." },
  { q: "כמה זמן לוקח להגיע לקריאת שירות?", a: "לקריאות דחופות אנו משתדלים להגיע באותו היום או ביום העסקים הבא באזור המרכז. לפרויקטים מתוכננים נקבע מראש לוח זמנים מדויק בתיאום עם הלקוח." },
];
